...
void RayMarchingCamera::_bind_methods()
{
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "cone_resolution_scale"), "set_cone_resolution_scale", "get_cone_resolution_scale");
    ...
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "cone_marching_enabled"), "set_cone_marching_enabled", "is_cone_marching_enabled");
}
...
void RayMarchingCamera::init()
{
    ...
    projection_matrix = Projection::create_perspective(fov, static_cast<float>(resolution.width) / resolution.height, near_plane, far_plane, false);
    ...
    { // ray marching parameters buffer
        ...
        render_parameters.backgroundColor = Vector4(background_color.r, background_color.g, background_color.b, background_color.a);
    ...
    { //cone marching texture
        auto cone_format = ray_marching_shader->create_texture_format(cone_marching_parameters.width, cone_marching_parameters.height, RenderingDevice::DATA_FORMAT_R32G32_SFLOAT);
        cone_image = Image::create(cone_marching_parameters.width, cone_marching_parameters.height, false, Image::FORMAT_RGF);        
